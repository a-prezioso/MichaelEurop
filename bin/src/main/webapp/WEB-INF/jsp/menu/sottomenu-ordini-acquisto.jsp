...
<head>
	...
	<title>Sottomenu Ordini Acquisto</title>
...
<div align="center">
	...
	<table>
		<tr>
			<td><input type="radio" name="scelta"  value="sottomenu-ordini-acquisto/ordine/creazione" checked="checked"> Creazione</td>
		</tr>
		<tr>
			<td><input type="radio" name="scelta"  value="sottomenu-ordini-acquisto/ordine/gestione"> Gestione</td>
		</tr>
		<tr>
			<td><input type="radio" name="scelta"  value="sottomenu-ordini-acquisto/ordine/ricerca"> Ricerca</td>
		</tr>
	</table>
	<br>
	<br>
